...
import { Student, Gender, SegakScore, ClassLevel } from '../types';
                ...
                <form onSubmit={handleSubmit} className="flex flex-col h-full">
                    <div className="p-6 sticky top-0 bg-brand-bg-light dark:bg-brand-bg-dark border-b dark:border-brand-dark-light z-10">
                        <div className="flex justify-between items-center">
                            <h2 className="text-xl font-bold text-brand-text-light dark:text-brand-text-dark">Edit Maklumat Murid</h2>
                        ...
                        <div className="border-b dark:border-brand-dark-light pb-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="name" id="name" value={formData.name} onChange={handleInputChange} className="mt-1 block w-full px-3 py-2 bg-brand-bg-light dark:bg-brand-dark border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-brand-primary focus:border-brand-primary sm:text-sm" />
                                </div>
                                <div>
                                    <label htmlFor="icNumber" className="block text-sm font-medium text-gray-700 dark:text-gray-300">No. KP</label>
                                    <input type="text" name="icNumber" id="icNumber" value={formData.icNumber} onChange={handleInputChange} className="mt-1 block w-full px-3 py-2 bg-brand-bg-light dark:bg-brand-dark border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-brand-primary focus:border-brand-primary sm:text-sm" />
                                </div>
                                <div>
                                    <label htmlFor="age" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Umur</label>
                                    <input type="number" name="age" id="age" value={formData.age} onChange={handleInputChange} className="mt-1 block w-full px-3 py-2 bg-brand-bg-light dark:bg-brand-dark border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-brand-primary focus:border-brand-primary sm:text-sm" />
                                </div>
                                <div>
